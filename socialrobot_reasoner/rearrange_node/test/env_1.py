...
def get_request():
    ...
    req.target = get_env_object_info(
        "obj_gotica", (0.374999523163, -2.85253895527e-06, 0.826809704304), DEFAULT_QUAT, DEFAULT_SCALE
    )
    # The obstacles on the workspace object
    req.objects = [
        get_env_object_info(
            "obj_red_gotica", (0.299999862909, 0.0999971851707, 0.82544863224), 
            DEFAULT_QUAT, 
            DEFAULT_SCALE
        ),
        get_env_object_info(
            "obj_diget", (0.299999862909, -0.100002810359, 0.825443446636), 
            DEFAULT_QUAT, 
            DEFAULT_SCALE
        )
    ]
    ...
    req.workspace = get_env_object_info(
        "table", (0.550005793571, 8.92382922757e-06, 0.36296159029), 
        (0.0, 0.0, 0.707113206387, 0.707100450993), 
