...
# necessary : obstacle_ids, obstacles, targetObject, grasp_point
...
class Pick_testBehavior(BehaviorBase):
    def __init__(self, name, **params):
        super(Pick_testBehavior, self).__init__(name, **params)
    ...
    def _call_ros_service(self, inputs):
        ...
        body_type_list = [MotionPlanRequest.RIGHT_ARM,
                          MotionPlanRequest.LEFT_ARM]
            ...
            for i, grasp_pose in enumerate(inputs.grasp_point):
                ...
                if _moveit.planResult == MotionPlanResponse.SUCCESS:
                    _manipulability_list.append(
                        (_moveit.manipulability, grasp_pose, body_type))
        ...
        for manipulability, grasp_pose, body_type in _manipulability_list:            
            # set targetBody
            ...
            for gripper_pose in _graspit.endEffectorPose:
                ...
                if _moveit.planResult == MotionPlanResponse.SUCCESS:
                    ...
                    # change distance...
                    approach_pos = self.approach_pos(gripper_pose, 0.1)
