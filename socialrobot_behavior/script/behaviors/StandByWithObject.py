...
class StandByWithObjectBehavior(BehaviorBase):
    ''' Joint Trajectory Following '''
    def __init__(self, name, **params):
        super(StandByWithObjectBehavior, self).__init__(name, **params)
        ...
        try:
            ...
            if robot_group == MotionPlanRequest.RIGHT_ARM or robot_group == MotionPlanRequest.RIGHT_GRIPPER:
                ...
                joint_state.position = [0, 0.48, #0, -0.3,
                                        -0.5812923908233643,0.6559696793556213, 1.1245719194412231, 1.553339958190918, -1.2502355575561523, 0.6452689170837402,
                                        ]
