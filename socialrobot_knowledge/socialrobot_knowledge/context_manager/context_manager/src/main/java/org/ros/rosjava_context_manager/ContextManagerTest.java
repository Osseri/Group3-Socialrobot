 ...
 */
public class ContextManagerTest extends AbstractNodeMain {
  ...
  static String knowrobFilePath = "/home/ubuntu/Desktop/test/social_ws/src/socialrobot/src/socialrobot_knowledge/cmProlog/knowrob_library/social_.owl";//knowrob.owl";
  ...
  public GraphName getDefaultNodeName() {
    return GraphName.of("context_manager_test");
  }
  ...
  public void onStart(final ConnectedNode connectedNode) {
    ...
    ContextManagerTest.connectedNode = connectedNode;
    ContextManagerTest.log = connectedNode.getLog();
  ...
  prefixes.put("http://www.w3.org/2001/XMLSchema","xsd");
    ...
    try {
      ...
      // for Predicate
      // pProviderForTM =
      // connectedNode.newPublisher("ContextManagerTest/Predicate/ProvisionForTM",
      // PredicateServiceResponse._TYPE);
      // pProviderForCM =
      // connectedNode.newPublisher("ContextManagerTest/Predicate/ProvisionForPM",
      // PredicateServiceResponse._TYPE);
      // receptionistForPr =
      // connectedNode.newSubscriber("ContextManagerTest/Predicate/Reception",
      ...
      mServiceServer = connectedNode.newServiceServer("context_manager/monitor/service", MonitorSimilarService._TYPE,
          new ServiceResponseBuilder<MonitorSimilarServiceRequest, MonitorSimilarServiceResponse>() {
            ...
            public void build(MonitorSimilarServiceRequest request, MonitorSimilarServiceResponse response) {
              ...
              mRequest.setManager("ContextManagerTest");
    ...
    receptionistForService.addMessageListener(new MessageListener<MainServiceRequest>() {
      ...
      public void onNewMessage(MainServiceRequest request) {
        ...
        for (int i = 0; i < request.getPredicate().size(); i++) {
          ...
          if (status == 9) {
            ContextManagerTest.log.info("<==============receive success==============>");
            /*
             * QueryServiceResponse response = qProviderForPM.newMessage();
             * response.setResult("Done");
             * 
             * if (request.getManager().equals("ContextManagerTest"))
  ...
  public void initialize() {
    ...
    ContextManagerTest.log.info(initialize + " " + (query.hasSolution() ? "successed" : "failed"));
     ...
     * = query.allSolutions(); ContextManagerTest.log.info("Cancellation------" + " " +
     * getResponse.length); for(int i = 0; i < getResponse.length; i++){ response +=
     * getResponse[i]; ContextManagerTest.log.info("Cancellation" + " " + response); }
     */
    // ContextManagerTest.log.info("Cancellation" + " " + response);
  ...
  public void rdf_retract(TempQuery request) {// MonitorServiceRequest request){
    ...
    //ContextManagerTest.log.info(rdf_retract + " " + (query.hasSolution() ? "successed" : "failed"));
    //ContextManagerTest.log.info("retract" + " " + (query.hasSolution() ? "successed" : "failed"));
  }
  ...
  public void monitor(TempQuery request) {// MonitorServiceRequest request) {
    ...
    ContextManagerTest.log.info(monitor + " " + (query.hasSolution() ? "successed" : "failed"));

  }

  public void monitored(String params) {
    ContextManagerTest.log.info("Monitored " + params);
    String data = null;
    Monitor message = publisherForTM.newMessage();
    setMessage(message, params);

    ContextManagerTest.log.info(message.getPredicate() + " " + message.getParam1() + " " + message.getParam2() + " "
    ...
    ContextManagerTest.log.info(message.getPredicate() + " " + (query.hasSolution() ? "successed" : "failed"));
    ...
    if (query.hasSolution()) {
      ...
      for (int i = 0; i < solutions.length; ++i) {
        ...
        // ContextManagerTest.log.info(data);
  ...
  public void regist1(TempQuery request) {// MonitorServiceRequest request) {
    ...
    ContextManagerTest.log.info("Registration" + " " + (query.hasSolution() ? "successed" : "failed"));
  }
  ...
  public void cancel1(TempQuery request) {// MonitorServiceRequest request) {
    ...
    ContextManagerTest.log.info("Cancellation" + " " + (query.hasSolution() ? "successed" : "failed"));
  }
  ...
  public void query(TempQuery request) {
    ...
    ContextManagerTest.log.info("receive Query: " + transQuery);
    ...
    for (int i = 0; i < preResponse.length; i++) {
      // ContextManagerTest.log.info("number iiiiiiiiiiiiiiiiiisssssssssssssssss "+i);
      // ContextManagerTest.log.info("들어옴");
      // MonitorServiceResponse response = mProviderForTM.newMessage();
      Parser.setResponse(request, preResponse[i], response);
      response.setManager("ContextManagerTest");
    ...
    ContextManagerTest.log.info("all response: " + transResponse);
    // ContextManagerTest.log.info("predicate:"+response.getPredicate()+",Param1:"+response.getParam1());
    ContextManagerTest.log.info("<========================= Success =========================>");
  }

  public void query2(TempQuery request) {// MonitorServiceRequest request){
    ContextManagerTest.log.info("receive Query: " + request.getPredicate());
...
//		    String edges="], \"edges\":[";
  ...
  try {
    String outDir = "/home/ubuntu/pyweb/src/webtest/gui/";
