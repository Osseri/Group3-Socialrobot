...
:- asserta(library_directory('/home/ubuntu/Desktop/test/social_ws/src/socialrobot/src/socialrobot_knowledge/cmProlog/matrix')).
...
:- rdf_load(library(owl/test_object_social)).
