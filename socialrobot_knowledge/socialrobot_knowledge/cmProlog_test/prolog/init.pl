...
:- asserta(library_directory('/home/ubuntu/Desktop/test/social_ws/src/socialrobot/src/socialrobot_knowledge/cmProlog/knowrob_library')).
:- asserta(library_directory('/home/ubuntu/Desktop/test/social_ws/src/socialrobot/src/socialrobot_knowledge/cmProlog/agent')).
...
:- use_module(library('prolog/demo/comp_spatial2')).
...
:- use_module(library('prolog/demo/predicate_  20191006')).
%:- use_module(library('prolog/arbi_convenient_service')).
:- use_module(library('prolog/global_variable')).
:- use_module(library('prolog/demo/arbi_comp_spatial')).
:- rdf_load(library(owl/semanticMap/object_rotMat)).
:- rdf_load(library(owl/robot_model)).
:- rdf_load(library(owl/semanticMap/object_info)).
:- rdf_load(library(owl/semanticMap/snap1204)).
%:- rdf_load(library(owl/semanticmap_demo_gazebo_added_information)).
