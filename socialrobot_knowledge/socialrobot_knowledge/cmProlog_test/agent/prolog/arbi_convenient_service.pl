...
emptySlot(Plane, Object, Goal) :-
  rdfs_individual_of(Object,  knowrob:'Artifact'),
  rdf(Plane, rdf:type, knowrob:'ShelfInABuilding'),
  rdf(Object, rdf:type, ObjectType),
  rdf(Plane, knowrob:'physicalParts', PlaneRegion),
  displayShelfFor(PlaneRegion, ObjectType),
  not(on_Physical(Object,PlaneRegion)),
  rdf(PlaneRegion, knowrob:'locatedAtPoint-Spatial', Placementpoint),
  not(on_placementpoint(Item, Placementpoint)),
  rdf(Placementpoint,'http://knowrob.org/kb/knowrob.owl#m03',literal(type(_,P1x))),atom_to_term(P1x,P1X,_),
  rdf(Placementpoint,'http://knowrob.org/kb/knowrob.owl#m13',literal(type(_,P1y))),atom_to_term(P1y,P1Y,_),
  rdf(Placementpoint,'http://knowrob.org/kb/knowrob.owl#m23',literal(type(_,P1z))),atom_to_term(P1z,P1Z,_),
  Goal = [P1X, P1Y, P1Z].
